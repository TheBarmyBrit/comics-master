package uk.co.alexander.barmymarvel.view;
...
import uk.co.alexander.barmymarvel.R;
import uk.co.alexander.barmymarvel.adapter.ComicRecyclerAdapter;
import uk.co.alexander.barmymarvel.model.Comic;
import uk.co.alexander.barmymarvel.presenter.ComicPresenterImpl;
import uk.co.alexander.barmymarvel.presenter.IComicPresenter;
import uk.co.alexander.barmymarvel.presenter.ISchedulerProvider;
import uk.co.alexander.barmymarvel.retrofit.MarvelInteractor;
import uk.co.alexander.barmymarvel.retrofit.MarvelRetrofit;

/**
 * A simple {@link Fragment} subclass to display the comic list
 */
public class ComicList extends Fragment implements IComicPresenter.IView, ComicRecyclerAdapter.OnClickHandler {
    // The view items, bound using Butterknife
    @BindView(R.id.rvComicList) RecyclerView rvComicList;
    // Our method attributes
    ComicRecyclerAdapter mComicListAdapter;
    ...
    public void onShowComics(List comicList) {
        ...
        mComicListAdapter = new ComicRecyclerAdapter(comicList, getContext(), this);
    ...
    public void filterOnPrice(Double price) {
        ...
        mComicListAdapter = new ComicRecyclerAdapter(filteredList, getContext(), this);
        rvComicList.setAdapter(mComicListAdapter);

    }

    public void clearFilter() {
        mComicListAdapter = new ComicRecyclerAdapter(mComicList, getContext(), this);
        rvComicList.setAdapter(mComicListAdapter);
    }
}
